...
- Sete migrações PostgreSQL analisadas pelo parser `pglast`: sintaxe válida.
...
- Workflow atualizado para `actions/checkout@v5`, `actions/upload-artifact@v6` e artefato `YePly-1.5.0-unsigned.ipa`.
...
- Versão atualizada para 1.5.0 (build 7).
